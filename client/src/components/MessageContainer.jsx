...
export const MessageContainer = () => {
  return (
    <div className="w-[95%] h-[140vh] lg:w-[70%] bg-green-500 flex flex-col justify-start items-center mt-2 mb-2 rounded-lg">
      <div className="text-[1.35rem] font-semibold mb-2 mt-2">
        Your Messages
      </div>
      <div className="w-[95%] h-[135vh] rounded-md mb-4 flex flex-col justify-start items-center bg-teal-400">
        <div className="w-full h-[10vh] bg-sky-400 rounded-tr-md rounded-tl-md flex justify-start items-center p-2 border-b-2 border-slate-300 mb-[2rem]">
        ...
        <div className="w-[95%] h-[95vh] bg-rose-400 overflow-y-auto overflow-x-hidden flex flex-col justify-start items-center p-2">
          {/* Initial Loading!   */}
          {false &&
            [0, 1, 2, 3, 4].map((item) => (
              <div
